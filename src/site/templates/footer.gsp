            ...
            <div class="row">
                <div class="col-6 col-sm-4 text-xs-center order-sm-2">
                    ...
                    <ul class="list-inline mb-0">
                        ...
                        <% } %>
                        <% if (config.site_footerGem) { %>
                        <li aria-label="Gem" class="list-inline-item mx-2 h3" data-original-title="Gem" data-placement="top"
                            data-toggle="tooltip" title="">
                            <a class="text-white" href="${config.site_footerGem}" rel="noopener noreferrer"
                               target="_blank">
